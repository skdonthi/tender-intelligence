...
export function DocumentRail({ docs, activeId, onSelect, onUpload, uploading }: Props) {
  ...
  return (
    <aside className="rail">
      ...
      >
        ...
        />
        <div className="upload-icon">{uploading ? <span className="spinner" /> : "⊕"}</div>
        <div className="upload-label">
          {uploading
            ? <span>Ingesting document…</span>
            : <><strong>Upload PDF</strong><br />procurement · tender · defence</>}
        </div>
      </div>
